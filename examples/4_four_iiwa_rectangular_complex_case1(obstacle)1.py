...
from hltl2gcs.support_functions import RigidTransform2Array,show_robot_4_iiwa_complex,findIndex, construct_labeled_convex_region, construct_connected_convex_region_RRT,RefineRegion, show_robot_4_iiwa_obs
...
atomic_propositions = {
    ...
    'target_5_place_object_2': [joint_label['robot1_in_target5']],
    'target_6_place_object_2': [joint_label['robot4_in_target6']],
    'target_1_pick_object_2': [joint_label['robot1_in_target1']],
    'target_1_place_object_2': [joint_label['robot1_in_target1']],
    'target_4_pick_object_1': [joint_label['robot4_in_target4']],  
    'target_3_place_object_2': [joint_label['robot3_in_target3']],
}
...
# this works!
# spec300 = "(F (target_1_pick_object_1 & F (target_4_place_object_1)))"
# spec400 = "(F (target_5_pick_object_2 & F (target_6_place_object_2 | target_3_place_object_3)))"
# spec500 = "(F (target_4_pick_object_1 & ! obstacle U target_1_place_object_1))"
# spec600 = "(F (target_5_pick_object_2 & F (target_1_place_object_2 | target_4_place_object_1)))"

# this work
spec300 = "(F (target_1_pick_object_1 & F (target_4_place_object_1)))"
spec400 = "(F (target_5_pick_object_2 & F (target_6_place_object_2 | target_3_place_object_3)))"
spec500 = "(F (target_1_pick_object_1 & ! obstacle U target_4_place_object_1))"
spec600 = "(F (target_5_pick_object_2 & F (target_1_place_object_2 | target_4_place_object_1)))"
...
if args.case == -1:
    ...
    level_two = dict()
    level_two["p100"] = "F p300 & F p400"    
    level_two["p200"] = "F (p500 & F p600)"    
    hierarchy.append(level_two)
    level_three = dict()
    level_three["p300"] = spec300 
    level_three["p400"] = spec400
    level_three["p500"] = spec500
    level_three["p600"] = spec600
...
if SHOW_ROBOT == True:
    ...
    q_object3_drop = RigidTransform2Array(RigidTransform(RollPitchYaw(-np.pi/2,np.pi/2,0).ToRotationMatrix(),[0, -0.52, 0.1]))
    ...
    show_robot_4_iiwa_complex(diagram, plant, visualizer,robot_num, q_object1_init,q_object2_init,q_object3_init, q_object1_drop,q_object2_drop,q_object3_drop, path_with_gripper, vertex_array, iiwa_attach_frame)
